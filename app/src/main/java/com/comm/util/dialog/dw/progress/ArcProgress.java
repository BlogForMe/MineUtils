...
//            textPaint.setTypeface(fontFace);
            if (isText) {
                canvas.drawText(mText, (getWidth() - textPaint.measureText(mText)) / 2.0f, textBaseline, textPaint);
            } else {
            ...
            if (!TextUtils.isEmpty(getProgressTextTop())) {
                ...
                canvas.drawText(getProgressTextTop(), (getWidth() - textPaint.measureText(getProgressTextTop())) / 2.0f, textBaseline + textHeight - dp2px(getResources(), 20), textPaint);
            }
            if (!TextUtils.isEmpty(getProgressTextBottom())) {
                ...
                canvas.drawText(getProgressTextBottom(), (getWidth() - textPaint.measureText(getProgressTextBottom())) / 2.0f, textBaseline - textHeight / 2 + dp2px(getResources(), 15), textPaint);
